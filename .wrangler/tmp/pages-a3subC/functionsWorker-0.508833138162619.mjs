...
async function onRequest({ request, env }) {
  ...
  const init = {
    ...
    redirect: "manual"
    // avoid auto-follow 307/308 with one-time-use body
  };
...
// ../.wrangler/tmp/pages-a3subC/functionsRoutes-0.15085163785115574.mjs
var routes = [
  {
    routePath: "/v1/:path*",
    mountPath: "/v1",
...
// ../.wrangler/tmp/bundle-YQGZMq/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-YQGZMq/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.508833138162619.mjs.map

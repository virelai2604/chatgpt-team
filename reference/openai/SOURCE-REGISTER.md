...
- **Open GAPs (2)** — pull priority order:
  1. `gh_openai_cookbook` — selected notebooks only (Responses / File Search / Agents / Evals).
  2. `gh_openai_node` — README/changelog metadata only.

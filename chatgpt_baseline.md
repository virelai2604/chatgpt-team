...
Repo: chatgpt-team
Base: origin/main
Base commit (merge-base): 3576fdc1e60585c994d82474e559fd56db3d5535
...
Mode: baseline
Generated: 2026-01-03T12:23:03+07:00

## TREE (repo root at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
 - .env.example.env
 - .gitattributes
 - .github
...
## TREE (app/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
 - app/__init__.py
 - app/api/__init__.py
...
## TREE (tests/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
 - tests/__init__.py
 - tests/client.py
 - tests/conftest.py
...
## TREE (static/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
 - static/.well-known/__init__.py
 - static/.well-known/ai-plugin.json
```

## TREE (schemas/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
 - schemas/__init__.py
 - schemas/openapi.yaml
```

## TREE (src/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
```

## TREE (scripts/src/ at 3576fdc1e60585c994d82474e559fd56db3d5535)
```
```

## BASELINE (ROOT FILES)

## FILE: project-tree.md @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
  📄 .env.env
  📄 .env.example.env
  📄 .gitattributes
...
## FILE: pyproject.toml @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
[build-system]
...
## FILE: chatgpt_sync.sh @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
#!/usr/bin/env bash
set -euo pipefail
...
## FILE: AGENTS.md @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
...
## FILE: __init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: generate_tree.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
#!/usr/bin/env python3
"""
...
## FILE: app/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: app/api/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: app/api/forward_openai.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
...
## FILE: app/api/routes.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/api/sse.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/api/tools_api.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
#app/api/tools_api
from __future__ import annotations
...
## FILE: app/core/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: app/core/config.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/core/http_client.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/core/logging.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
"""
...
## FILE: app/core/settings.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/http_client.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/main.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/manifests/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# ==========================================================
...
## FILE: app/manifests/tools_manifest.json @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
{
  "object": "list",
  "data": [
...
## FILE: app/middleware/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: app/middleware/p4_orchestrator.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/middleware/p4_orchestrator.py
import uuid
...
## FILE: app/middleware/relay_auth.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/middleware/validation.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/models/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
...
## FILE: app/models/error.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/routes/__init__.py
...
## FILE: app/routes/actions.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/routes/actions.py
...
## FILE: app/routes/batches.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/containers.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/conversations.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/embeddings.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/files.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/health.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/images.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/api/images.py
from __future__ import annotations
...
## FILE: app/routes/models.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/routes/models.py
...
## FILE: app/routes/proxy.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/realtime.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/routes/realtime.py
...
## FILE: app/routes/register_routes.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/routes/register_routes.py
...
## FILE: app/routes/responses.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/uploads.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/vector_stores.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/routes/videos.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/utils/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: app/utils/authy.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/utils/error_handler.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# app/utils/error_handler.py
...
## FILE: app/utils/http_client.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: app/utils/logger.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: tests/client.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# tests/client.py
...
## FILE: tests/conftest.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/relay_client_example.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# relay_client_example.py
from __future__ import annotations
...
## FILE: tests/test_extended_routes_smoke_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
...
## FILE: tests/test_files_and_batches_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
"""
tests/test_files_and_batches_integration.py
...
## FILE: tests/test_images_variations_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
import binascii
import os
import struct
...
## FILE: tests/test_local_e2e.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# tests/test_local_e2e.py
from __future__ import annotations
...
## FILE: tests/test_realtime_ws_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/test_realtime_ws_local.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/test_relay_auth_guard.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
# tests/test_relay_auth_guard.py
...
## FILE: tests/test_remaining_routes_smoke_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/test_sse_stream_open.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/test_success_gates_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: tests/test_videos_actions_integration.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
from __future__ import annotations
...
## FILE: static/.well-known/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: static/.well-known/ai-plugin.json @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
{
  "schema_version": "v1",
...
## FILE: schemas/__init__.py @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
```

## FILE: schemas/openapi.yaml @ 3576fdc1e60585c994d82474e559fd56db3d5535
```
openapi: 3.1.0
info:
  title: ChatGPT Team Relay
